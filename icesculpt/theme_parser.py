...
def create_empty_theme(theme_name="New Theme", author=""):
    ...
    raw_lines = [
        ...
        f'',
        f'# Title bar colors',
        f'ColorActiveTitleBar="rgb:00/00/80"',
        f'ColorActiveTitleBarText="rgb:FF/FF/FF"',
        f'ColorNormalTitleBar="rgb:C0/C0/C0"',
        f'ColorNormalTitleBarText="rgb:00/00/00"',
        f'',
        f'# Border colors',
        f'ColorActiveBorder="rgb:00/00/80"',
        f'ColorNormalBorder="rgb:C0/C0/C0"',
        f'',
        f'# Menu colors',
        f'ColorNormalMenu="rgb:C0/C0/C0"',
        f'ColorNormalMenuItemText="rgb:00/00/00"',
        f'ColorActiveMenuItem="rgb:00/00/80"',
        f'ColorActiveMenuItemText="rgb:FF/FF/FF"',
        f'',
        f'# Taskbar colors',
        f'ColorDefaultTaskBar="rgb:C0/C0/C0"',
        f'',
        f'# Dimensions',
        f'BorderSizeX=6',
        f'BorderSizeY=6',
